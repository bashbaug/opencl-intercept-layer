...
CEnumNameMap::CEnumNameMap()
{
    ...
    ADD_ENUM_NAME( m_cl_int, CL_MUTABLE_COMMAND_PROPERTIES_ARRAY_KHR );
    ...
    ADD_ENUM_NAME( m_cl_command_buffer_update_type_khr, CL_STRUCTURE_TYPE_MUTABLE_DISPATCH_CONFIG_KHR );
