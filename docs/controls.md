...
##### `Emulate_cl_khr_suggested_local_work_size` (bool)

If set to a nonzero value, the Intercept Layer for OpenCL Applications will emulate support for the cl\_khr\_suggested\_local\_work\_size extension.
